export const stateList = [
    ...
    { "id": "60", "code": "AS", "name": "American Samoa" },
    { "id": "66", "code": "GU", "name": "Guam" },
    { "id": "69", "code": "MP", "name": "Northern Mariana Islands" },
    { "id": "72", "code": "PR", "name": "Puerto Rico" },
    { "id": "78", "code": "VI", "name": "Virgin Islands" }
  ];